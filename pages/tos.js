							...
							<div className="container">
								<div className="tos">
									...
									<p>
										...
										if you do not agree to take all of the
									...
									<p>
										...
										, you agreed to use cookies in agreement
										with the{" "}
										<span class="highlight preview_company_name">
											{t("siteTitle")}
										</span>
									...
									<p>
										...
										for your own personal use subjected to
										restrictions set in these terms and
										conditions.
									</p>
									<p>You must not:</p>
									<ul>
									...
									<p>
										...
										website. Comments do not reflect the
										views and opinions of{" "}
										<span class="highlight preview_company_name">
											{t("siteTitle")}
										</span>
										,its agents and/or affiliates. Comments
										...
										for any liability, damages or expenses
										caused and/or suffered as a result of
									...
									<p>
										...
										reproduce, edit and authorize others to
										use, reproduce and edit any of your
									...
									<p>
										...
										of any URLs from which you intend to
										link to our Website, and a list of the
										URLs on our site to which you would like
									...
									<p>
										...
										's logo or other artwork will be allowed
