...
}, __jsx("li", null), __jsx("li", null), __jsx("li", {
  style: {
    width: "61%"
  }
})))));
...
var _default = (0, _react.memo)(() => {
  ...
  return __jsx(_react.default.Fragment, null, __jsx("div", {
    ...
    id: "form",
    className: "form"
  }, __jsx("h2", null, "\u0417\u0430\u043F\u043E\u043B\u043D\u0438\u0442\u0435 \u0444\u043E\u0440\u043C\u0443 \u043D\u0438\u0436\u0435 \u0438 \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \u043A\u043D\u043E\u043F\u043A\u0443 \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C."), __jsx("ul", null, __jsx("li", null, "\u041D\u0435 \u0443\u043A\u0430\u0437\u044B\u0432\u0430\u0439\u0442\u0435 \u0430\u0434\u0440\u0435\u0441 \u043A\u0432\u0430\u0440\u0442\u0438\u0440\u044B \u0438\u043B\u0438 \u0434\u043E\u043C\u0430."), __jsx("li", null, "\u041D\u0435 \u0443\u043A\u0430\u0437\u044B\u0432\u0430\u0439\u0442\u0435 \u043A\u043E\u043D\u043A\u0442\u0440\u0435\u0442\u043D\u044B\u0435 \u0438\u043D\u0438\u0446\u0438\u0430\u043B\u044B."), __jsx("li", null, "\u041F\u0440\u0438 \u043D\u0430\u0440\u0443\u0448\u0435\u043D\u0438\u0438 \u0432\u044B\u0448\u0435\u043F\u0435\u0440\u0435\u0447\u0438\u0441\u043B\u0435\u043D\u043D\u043E\u0433\u043E \u043E\u043F\u043E\u0432\u0435\u0449\u0435\u043D\u0438\u0435 \u0431\u0443\u0434\u0435\u0442 \u0443\u0434\u0430\u043B\u0435\u043D\u043E.")), __jsx("form", null, __jsx("input", {
    type: "email",
    name: "email",
...
var _GoogleMaps = _interopRequireDefault(__webpack_require__("jzx0"));

var _Subscribe = _interopRequireDefault(__webpack_require__("Ru+e"));

var _MakeMark = _interopRequireDefault(__webpack_require__("JAzZ"));

var _ActivityArea = _interopRequireDefault(__webpack_require__("mcbd"));

var _Socials = _interopRequireDefault(__webpack_require__("Y+zY"));

__webpack_require__("8oQk");
...
const Home = props => {
  ...
  return __jsx("main", null, __jsx("section", {
    className: "mapArea"
  }, __jsx(_GoogleMaps.default, props)), __jsx("section", {
    className: "mainBlock"
  }, __jsx(_Socials.default, _extends({}, props, siteMeta)), __jsx(_MakeMark.default, props), __jsx(_ActivityArea.default, props), __jsx(_Subscribe.default, props)));
};
...
var _reactFontawesome = __webpack_require__("uhWA");

var _fontawesomeFreeSolid = __webpack_require__("2To/");

var _phone = _interopRequireDefault(__webpack_require__("jjKT"));

var _email = _interopRequireDefault(__webpack_require__("yCne"));

var _phones = _interopRequireDefault(__webpack_require__("4baR"));
...
var _default = () => {
  ...
  }, __jsx("h2", null, "\u041E\u0441\u0442\u0430\u0432\u044C\u0442\u0435 \u0441\u0432\u043E\u0439 \u043D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430 \u0438\u043B\u0438 \u0438\u043C\u0435\u0439\u043B \u0438 \u043C\u044B \u0432\u0430\u0441 \u043E\u043F\u043E\u0432\u0435\u0441\u0442\u0438\u043C \u0435\u0441\u043B\u0438 \u0435\u0441\u0442\u044C \u0440\u044F\u0434\u043E\u043C \u0441\u043B\u0443\u0447\u0430\u0439 \u0437\u0430\u0440\u0430\u0436\u0435\u043D\u043D\u0438\u044F."), __jsx("div", {
    className: "sel"
  }, ["phone", "email"].map((w, x) => {
    return __jsx("img", {
      key: x,
  ...
  }[state.via || ""], __jsx("button", null, __jsx(_reactFontawesome.FontAwesomeIcon, {
...
var _freeBrandsSvgIcons = __webpack_require__("JVe5");
...
var _googleMapsReact = __webpack_require__("yOsI");

var _m = _interopRequireDefault(__webpack_require__("k0JK"));
...
var _xmlToJson = _interopRequireDefault(__webpack_require__("dLag"));

var _Skeleton = __webpack_require__("49df");
...
var _default = ({
  ...
  return __jsx("div", {
  ...
  }, __jsx("nav", null, __jsx("ol", null, [{
    id: "local",
    title: __jsx(Pin, null)
  }, {
    id: "acts",
    title: "Активность"
  }, {
    ...
    className: "comments"
  }, __jsx("h3", null, "\u041A\u043E\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0438 (", comments.length || 0, ")"), comments ? comments.map((c, cx) => {
    return __jsx("div", {
      className: "cm author",
      key: cx
    }, __jsx("div", {
      className: "chead"
    }, __jsx("b", null, c.user), c.date ? __jsx("span", null, " - " + c.date) : ""), __jsx("div", {
      className: "cbody"
    }, c.content));
