  ...
  (0, _react.useEffect)(function () {
    if (true) {
      ...
      if (geo) {
        ...
        fetch("http://www.geoplugin.net/json.gp").then(function (res) {
          return res.json();
        }).then(function (res) {
          var geo = (0, _keys.default)(res).reduce(function (p, n) {
            return (0, _assign.default)({}, p, (0, _defineProperty3.default)({}, n.replace("geoplugin_", ""), res[n]));
          }, {});
          localStorage.setItem("geo", (0, _stringify.default)(geo));
          setStore({
            geo: geo
          });
        });
...
//# sourceMappingURL=_app.js.4a299b388b450dcacd77.hot-update.js.map