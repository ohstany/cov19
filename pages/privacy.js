							...
							<div className="container">
								<div className="tos">
									...
									<p>
										...
										information collected offline or via
									...
									<p>
										...
										asked to provide, and the reasons why
										you are asked to provide it, will be
										made clear to you at the point we ask
										you to provide your personal
										information.
									</p>
									<p>
										...
										number, the contents of the message
										and/or attachments you may send us, and
									...
									<p>
										...
										including items such as name,{" "}
										{t("siteTitle")}, address, email
									...
									<ul>
										...
										<li>
											...
											directly or through one of our
											partners, including for customer
											service, to provide you with updates
											and other information relating to
											the webste, and for marketing and
									...
									<p>
										...
										follows a standard procedure of using
										log files. These files log visitors when
										they visit websites. All hosting
										companies do this and a part of hosting
										services' analytics. The information
										collected by log files include internet
										protocol (IP) addresses, browser type,
										Internet Service Provider (ISP), date
										and time stamp, referring/exit pages,
										and possibly the number of clicks. These
										are not linked to any information that
										is personally identifiable. The purpose
									...
									<p>
										Google is one of a third-party vendor on
										our site. It also uses cookies, known as
										DART cookies, to serve ads to our site
										visitors based upon their visit to
										www.https://cov19.online and other sites
										on the internet. However, visitors may
										choose to decline the use of DART
										cookies by visiting the Google ad and
										content network Privacy Policy at the
										following URL –{" "}
										<a
									...
									<p>
										Some of advertisers on our site may use
										cookies and web beacons. Our advertising
										partners are listed below. Each of our
										advertising partners has their own
										Privacy Policy for their policies on
										user data. For easier access, we
									...
									<p>
										...
										JavaScript, or Web Beacons that are used
										in their respective advertisements and
										links that appear on{" "}
										<span className="highlight preview_website_name">
											{t("siteTitle")}
										</span>
										, which are sent directly to users'
										browser. They automatically receive your
										IP address when this occurs. These
									...
									<p>
										...
										has no access to or control over these
									...
									<p>
										...
										's Privacy Policy does not apply to
										other advertisers or websites. Thus, we
										are advising you to consult the
										...
										opt-out of certain options. You may find
										a complete list of these Privacy
									...
									<p>
										...
										cookie management with specific web
										browsers, it can be found at the
										browsers' respective websites. What Are
										Cookies?
									</p>
									<p>
										<strong>
											CCPA Privacy Policy (Do Not Sell My
									...
									<p>
										...
										categories and specific pieces of
										personal data that a business has
									...
									<p>
										...
										we complete the information you believe
										is incomplete.
									</p>
									<p>
									...
									<p>
										...
										the right to request that we transfer
										the data that we have collected to
										another organization, or directly to
